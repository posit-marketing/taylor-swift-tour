...
`r knitr::include_graphics("images/annual-highest-grossing-tours-bar-1.png")`
...
`r knitr::include_graphics("images/num-shows-vs-income-1.png")`

:::{style="font-family: Abril Fatface"}
#### Cost per ticket
:::

`r knitr::include_graphics("images/cost-per-ticket-scatterplot-1.png")`
