...
And on March 17th, kicked off the tour with _Miss Americana & The Heartbreak Prince _in front of 75,000 [shrieking, crying, and euphoric Swifties](https://youtu.be/GSVrEZCmfPM?si=6tGUaglLgK2I6vYf) at State Farm Stadium. The several bear attacks endured to get there – forgotten.
...
vbs <- list(
  ...
  value_box(
    ...
    style = 'background-color: #6D6268!important;'
  )
)
