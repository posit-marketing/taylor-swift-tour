...
![](images/ticketmaster_traffic.png)
...
#| fig-align: right
library(ggplot2)
load(here::here("images", "highest-grossing-tour-bar-1990s.rdata"))
bar_1990s
```
...
#| fig-align: right
library(ggplot2)
load(here::here("images", "highest-grossing-tour-bar-2000s.rdata"))
bar_2000s
```
...
#| fig-align: right
library(ggplot2)
load(here::here("images", "highest-grossing-tour-bar-2010s.rdata"))
bar_2010s
```
...
#| fig-align: right
library(ggplot2)
load(here::here("images", "highest-grossing-tour-bar-2020s.rdata"))
bar_2020s
```
...
card(
  ...
  layout_column_wrap(
    width = NULL, height = 280, fill = FALSE,
    style = glue(
