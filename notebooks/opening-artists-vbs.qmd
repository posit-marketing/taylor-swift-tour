...
for (i in 1:length(openers$artist |> unique())){
  ...
  vbs_artists[[artist_i]] <- list(
    ...
    value_box(
      ...
      full_screen = TRUE,
      style = glue('background-color: {yt_color}!important;')
    ),
    value_box(
      ...
      full_screen = TRUE,
      style = glue('background-color: {shazam_color}!important;')
    ),
    value_box(
      ...
      full_screen = TRUE,
      style = glue('background-color: {spotify_color}!important;')
    )
  )
}
