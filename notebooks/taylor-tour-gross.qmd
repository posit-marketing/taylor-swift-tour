...
ind_tab <- 
  ...
  dplyr::mutate(attendance = case_when(title == "The Eras Tour" ~ 10512000,
                ...
                label = paste0(title, "<br><span style='font-size:20pt'>", scales::dollar(adjusted_gross_in_2023_dollar), "</span>"),
...
taylor_treemap <-
  ...
  draw_image(here::here("images", "rev-by-tour-bg.png"),
             scale = 1.5,
             x = 0,
             y = 0.14) +
